  ...
  return (
    <>
      <div className="sm:flex sm:flex-col sm:w-64 bg-gray-700 pb-2">
        <div className="sm:flex sm:flex-col sm:flex-1 sm:overflow-y-auto">
          <nav className="sm:flex-1 sm:px-2 sm:py-2 bg-gray-700">

            <div className="font-normal text-lg text-gray-300 mb-5 ml-3 mt-5">People</div>

            <SidebarLink to="/dashboard/users" label="Users" pathname={location.pathname} 
            svg={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" /></svg>
            }/>
            <SidebarLink to="/dashboard/mechanics" label="Mechanics" pathname={location.pathname} 
            svg={
            ...
            <SidebarLink to="/dashboard/accountants" label="Accountants" pathname={location.pathname} 
            svg={
            ...
            <SidebarLink to="/dashboard/managers" label="Managers" pathname={location.pathname} 
            svg={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.496-3.03c.317-.384.74-.626 1.208-.766M11.42 15.17l-4.655 5.653a2.548 2.548 0 1 1-3.586-3.586l6.837-5.63m5.108-.233c.55-.164 1.163-.188 1.743-.14a4.5 4.5 0 0 0 4.486-6.336l-3.276 3.277a3.004 3.004 0 0 1-2.25-2.25l3.276-3.276a4.5 4.5 0 0 0-6.336 4.486c.091 1.076-.071 2.264-.904 2.95l-.102.085m-1.745 1.437L5.909 7.5H4.5L2.25 3.75l1.5-1.5L7.5 4.5v1.409l4.26 4.26m-1.745 1.437 1.745-1.437m6.615 8.206L15.75 15.75M4.867 19.125h.008v.008h-.008v-.008Z" /></svg>
            }/>
            
            <div className="font-normal text-lg text-gray-300 mb-5 ml-3 mt-8">Business</div>

            <SidebarLink to="/dashboard/services" label="Services" pathname={location.pathname} 
            svg={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75 2.25 12l4.179 2.25m0-4.5 5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-4.179 2.25m0 0L21.75 12l-4.179 2.25m0 0 4.179 2.25L12 21.75 2.25 16.5l4.179-2.25m11.142 0-5.571 3-5.571-3" /></svg>
            }/>
            <SidebarLink to="/dashboard/tickets" label="Tickets" pathname={location.pathname} 
            svg={
            ...
            <SidebarLink to="/dashboard/invoices" label="Invoices" pathname={location.pathname} 
            svg={
            ...
            <SidebarLink to="/dashboard/assignments" label="Assignments" pathname={location.pathname} 
            svg={
            ...
            <SidebarLink to="/dashboard/cars" label="Cars" pathname={location.pathname} 
            svg={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" /></svg>
            }/>
            ...
            <SidebarLink to="/dashboard/reviews" label="Reviews" pathname={location.pathname} 
            svg={
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M12 7.5h1.5m-1.5 3h1.5m-7.5 3h7.5m-7.5 3h7.5m3-9h3.375c.621 0 1.125.504 1.125 1.125V18a2.25 2.25 0 0 1-2.25 2.25M16.5 7.5V18a2.25 2.25 0 0 0 2.25 2.25M16.5 7.5V4.875c0-.621-.504-1.125-1.125-1.125H4.125C3.504 3.75 3 4.254 3 4.875V18a2.25 2.25 0 0 0 2.25 2.25h13.5M6 7.5h3v3H6v-3Z" /></svg>
            }/>
            <SidebarLink to="/dashboard/ticket-updates" label="Ticket Updates" pathname={location.pathname} 
            svg={
