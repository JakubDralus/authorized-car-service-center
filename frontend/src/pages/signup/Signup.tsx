...
const Signup = () => {
    ...
    const handleEmailValidation = (data: any) => {
        try {
    ...
    return (
        <>
            <div className="w-full h-screen flex">
                <div
                    className={`h-full w-3/5 bg-white transition-width duration-500 ease-in-out ${expandedSide === 'left' ? 'w-3/4' : ''}`}
                ...
                <div
                    className={`h-full w-2/5 right-bgcolor transition-width duration-500 ease-in-out ${expandedSide === 'right' ? 'w-3/5' : ''}`}
