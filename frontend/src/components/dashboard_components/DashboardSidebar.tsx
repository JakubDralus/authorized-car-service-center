      ...
      <div className="sm:flex sm:flex-col sm:w-64 bg-gray-700 pb-2">
        <div className="sm:flex sm:flex-col sm:flex-1 ">
          <nav className="sm:flex-1 sm:py-2 bg-gray-700 px-2 pb-3">
            ...
            <SidebarLink 
              onClick = {() => onSelectComponent('mechanics')}
              label = "Mechanics"
              isActive = {activeComponent === 'mechanics'}
            ...
            />
            <SidebarLink
              onClick={() => onSelectComponent('accountants')}
              label="Accountants"
              isActive={activeComponent === 'accountants'}
            ...
            />
            <SidebarLink
              onClick={() => onSelectComponent('managers')}
              label="Managers"
              isActive={activeComponent === 'managers'}
            ...
            <SidebarLink 
              onClick={() => onSelectComponent('services')}
              label="Services"
              isActive={activeComponent === 'services'}
            ...
            />
            <SidebarLink
              onClick={() => onSelectComponent('tickets')}
              label="Tickets"
              isActive={activeComponent === 'tickets'}
            ...
            <SidebarLink 
              ...
              label="Invoices"
              isActive={activeComponent === 'invoices'}
            ...
            />
            <SidebarLink 
              onClick={() => onSelectComponent('assignments')}
              label="Assignments"
              isActive={activeComponent === 'assignments'}
            ...
            />
            <SidebarLink 
              onClick={() => onSelectComponent('cars')}
              label="Cars"
              isActive={activeComponent === 'cars'}
            ...
            <SidebarLink 
              onClick={() => onSelectComponent('reviews')}
              label="Reviews"
              isActive={activeComponent === 'reviews'}
            ...
            />
            <SidebarLink 
              onClick={() => onSelectComponent('ticket-updates')}
              label="Ticket Updates"
              isActive={activeComponent === 'ticket-updates'}
